<script>
    ...
    var symptoma_banner_link_text = '<?=_e("Start Test", SYMPTOMA_COVID19_SLUG)?>';
    var symptoma_banner_link_url = '<?=_e("https://www.symptoma.co.uk/covid-19", SYMPTOMA_COVID19_SLUG)?>';
</script>
